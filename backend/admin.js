    ...
    var storage = [
        {
            ...
            link:"",
            descrip:"Se require la realizaci�n de una pagina web que permite a los clientes la realizacion de pedidos, la misma " +
...
app.controller('AppCtrl',['$scope','$firebaseObject','projects','tools',function($scope,$firebaseObject, projects,tools){
    ...
    $scope.isLogin = (sessionStorage.getItem('login') != null) ? 1: 0;
